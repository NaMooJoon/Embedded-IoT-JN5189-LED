...
void BOARD_InitPins(void)
{
    ...
    /* PWM for LED1 */
    IOCON_PinMuxSet(IOCON, 0, 0, ((IOCON->PIO[0][0] & (~(IOCON_PIO_FUNC_MASK | IOCON_PIO_DIGIMODE_MASK)))
								| IOCON_PIO_FUNC(4)
								| IOCON_PIO_DIGIMODE(1)));

    IOCON_PinMuxSet(IOCON, 0, 3, ((IOCON->PIO[0][3] & (~(IOCON_PIO_FUNC_MASK | IOCON_PIO_DIGIMODE_MASK)))
    								| IOCON_PIO_FUNC(4)
    								| IOCON_PIO_DIGIMODE(1)));

    IOCON_PinMuxSet(IOCON, 0, 6, ((IOCON->PIO[0][6] & (~(IOCON_PIO_FUNC_MASK | IOCON_PIO_DIGIMODE_MASK)))
    								| IOCON_PIO_FUNC(4)
    								| IOCON_PIO_DIGIMODE(1)));
    /* USART1 RX/TX pin */
...
//
    /* USART1 RX pin */
//	IOCON_PinMuxSet(IOCON, 0, 7, ((IOCON->PIO[0][7] & (~(IOCON_PIO_FUNC_MASK | IOCON_PIO_DIGIMODE_MASK)))
//								| IOCON_PIO_FUNC(6)
//								| IOCON_PIO_DIGIMODE(1)));
    /* I2C0  */
